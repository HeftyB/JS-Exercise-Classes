...
class Car {
  constructor (models, milesPerGallons) {
    this.model = models;
...
class Instructor extends Lambdasian {
  ...
  grade (studentOb, studentSt) {
    return `${studentOb.name} receives a perfect score on ${studentSt}`;
  }
...
class ProjectManager extends Instructor {
  ...
  debugsCode (studentOb, studentSt) {
    return `${this.name} debugs ${studentOb.name}'s code on ${studentSt}`;
  }
